...
<html>
<head>
	<title>Guiness WR Website - Register</title>
		<meta charset="utf-8">
	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
		<div class="container">
	        ...
	        <span class="icon-bar"></span>
				...
				<a href="index.php" class="navbar-brand">Guiness</a>
			</div>
	...
	<div>
	    ...
	    <form action="action_newrecord.php" method="POST">
		  ...
		  <div class="form-group col-md-6">
	      	...
	      	<input type="text" name="lastname" id="lastname" required placeholder="XXXXXX" class="form-control" pattern=".{5,10}" title="5 to 10 characters">
		  </div>
	      <div class="form-group col-md-6">
		    <label for="agentid">Record:</label>
      		<input type="text" name="record" id="area" required placeholder="Record achievement here" class="form-control" maxlength="15">
		  </div>
		  <div class="form-group col-md-6">
		    <label for="dept">ref:</label>
      		<input type="text" name="ref" id="crime" required placeholder="aaaa" class="form-control">
		  </div>
		  <div class="form-group col-md-6">
