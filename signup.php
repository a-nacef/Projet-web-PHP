...
<html>
<head>
	<title>Guiness World Records - Register</title>
		<meta charset="utf-8">
	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
		<div class="container">
	        ...
	        <span class="icon-bar"></span>
				...
				<a href="index.php" class="navbar-brand">Guinness</a>
			</div>
	    ...
	    <form action="action_signup.php" method="POST">
	      ...
	      <div class="form-group col-md-6">
		    <label for="agentid">ID:</label>
      		<input type="text" name="id" id="agentid" required placeholder="XXXXXX" class="form-control" maxlength="6">
		  </div>
		  <div class="form-group col-md-6">
		    <label for="dept">Age:</label>
      		<input type="text" name="age" id="age" required placeholder="18" class="form-control">
		  </div>
		  <div class="form-group col-md-6">
